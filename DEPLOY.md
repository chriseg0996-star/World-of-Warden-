# Deploying World of Warden on AWS
...
> https://worldofwarden.com. Re-running
...
`https://github.com/chriseg0996-star/world-of-warden-.git` anonymously. If you
...
- **Production**: point `admin.worldofwarden.com` at the instance
