...
const titleOverrides: Partial<Record<SupportedLanguage, Record<string, string>>> = {
  es: {
    ...
    "Alpha Predator": "Depredador alfa",
    ...
    "Arcane Study": "Estudio arcano",
    "Barrier Mastery": "Maestría de barrera",
    "Burning Soul": "Alma ardiente",
    "Kindling": "Yesca",
    "Pyromancy": "Piromancia",
    "School Path": "Senda escolar",
    "Winter Vitality": "Vitalidad invernal",
    "Winter's Embrace": "Abrazo del invierno",
    ...
    "Cruelty": "Crueldad",
    "Darkness": "Oscuridad",
    "Deadliness": "Pericia letal",
    "Deadly Finish": "Remate mortal",
    "Deadly Precision": "Precisión mortal",
    "Adrenaline Focus": "Concentración de adrenalina",
    "Blade Work": "Maestría de hoja",
    "Fighting Style": "Estilo de lucha",
    "Finishing Moves": "Movimientos finales",
    "Lethality": "Letalidad",
    "Murderous Finish": "Remate asesino",
    "Quick Reflexes": "Reflejos rápidos",
    "Ruthless Efficiency": "Eficiencia despiadada",
    "Ruthlessness": "Despiadado",
    "Weapon Skill": "Habilidad con armas",
    "Deep Wounds": "Heridas profundas",
    "Deflection": "Desvío",
