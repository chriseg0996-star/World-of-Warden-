...
const phase5 = {
  ...
  es: {
    itemUi: {
      ...
      equipment: { empty: "Vacío", levelClass: "Nivel {level} {className}", activate: "Activar {name}", chromaList: "Apariencia del personaje", chromaOption: "Apariencia {index}" },
  ...
  fr_FR: {
    itemUi: {
      ...
      equipment: { empty: "Vide", levelClass: "Niveau {level} {className}", activate: "Activer {name}", chromaList: "Apparence du personnage", chromaOption: "Apparence {index}" },
  ...
  it_IT: {
    itemUi: {
      ...
      equipment: { empty: "Vuoto", levelClass: "Livello {level} {className}", activate: "Attiva {name}", chromaList: "Aspetto del personaggio", chromaOption: "Aspetto {index}" },
  ...
  de_DE: {
    itemUi: {
      ...
      equipment: { empty: "Leer", levelClass: "Stufe {level} {className}", activate: "{name} aktivieren", chromaList: "Charakteraussehen", chromaOption: "Aussehen {index}" },
  ...
  zh_CN: {
    itemUi: {
      ...
      equipment: { empty: "空", levelClass: "{level} 级 {className}", activate: "激活{name}", chromaList: "角色外观", chromaOption: "外观 {index}" },
  ...
  zh_TW: {
    itemUi: {
      ...
      equipment: { empty: "空", levelClass: "{level} 級 {className}", activate: "啟動{name}", chromaList: "角色外觀", chromaOption: "外觀 {index}" },
  ...
  ko_KR: {
    itemUi: {
      ...
      equipment: { empty: "비어 있음", levelClass: "{level}레벨 {className}", activate: "{name} 사용", chromaList: "캐릭터 외형", chromaOption: "외형 {index}" },
  ...
  ja_JP: {
    itemUi: {
      ...
      equipment: { empty: "空", levelClass: "レベル{level} {className}", activate: "{name}を使用", chromaList: "キャラクターの外見", chromaOption: "外見 {index}" },
  ...
  pt_BR: {
    itemUi: {
      ...
      equipment: { empty: "Vazio", levelClass: "Nível {level} {className}", activate: "Ativar {name}", chromaList: "Aparência do personagem", chromaOption: "Aparência {index}" },
  ...
  ru_RU: {
    itemUi: {
      ...
      equipment: { empty: "Пусто", levelClass: "Уровень {level} {className}", activate: "Активировать {name}", chromaList: "Внешний вид персонажа", chromaOption: "Внешность {index}" },
