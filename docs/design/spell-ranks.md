# World of Warden — Ability Rank Progressions, Levels 1–20 (all nine classes)
...
Files to touch when implementing: `/Users/reubenhorne/Documents/code/levy-street/world-of-warden/src/sim/data.ts` (ABILITIES ranks + new entries, CLASSES.abilities arrays, 2 conjured-water items), `/Users/reubenhorne/Documents/code/levy-street/world-of-warden/src/sim/types.ts` (one new AbilityEffect variant `finisherStun`, XP_TABLE/MAX_LEVEL extension per the brief).