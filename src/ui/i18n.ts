...
const phase5 = {
  ...
  es: {
    itemUi: {
      ...
      equipment: { empty: "Vacío", levelClass: "Nivel {level} {className}", activate: "Activar {name}" },
  ...
  fr_FR: {
    itemUi: {
      ...
      equipment: { empty: "Vide", levelClass: "Niveau {level} {className}", activate: "Activer {name}" },
  ...
  it_IT: {
    itemUi: {
      ...
      equipment: { empty: "Vuoto", levelClass: "Livello {level} {className}", activate: "Attiva {name}" },
  ...
  de_DE: {
    itemUi: {
      ...
      equipment: { empty: "Leer", levelClass: "Stufe {level} {className}", activate: "{name} aktivieren" },
  ...
  zh_CN: {
    itemUi: {
      ...
      equipment: { empty: "空", levelClass: "{level} 级 {className}", activate: "激活{name}" },
  ...
  zh_TW: {
    itemUi: {
      ...
      equipment: { empty: "空", levelClass: "{level} 級 {className}", activate: "啟動{name}" },
  ...
  ko_KR: {
    itemUi: {
      ...
      equipment: { empty: "비어 있음", levelClass: "{level}레벨 {className}", activate: "{name} 사용" },
  ...
  ja_JP: {
    itemUi: {
      ...
      equipment: { empty: "空", levelClass: "レベル{level} {className}", activate: "{name}を使用" },
  ...
  pt_BR: {
    itemUi: {
      ...
      equipment: { empty: "Vazio", levelClass: "Nível {level} {className}", activate: "Ativar {name}" },
  ...
  ru_RU: {
    itemUi: {
      ...
      equipment: { empty: "Пусто", levelClass: "Уровень {level} {className}", activate: "Активировать {name}" },
