...
const esQuestNarratives = {
  ...
  q_fc_enter: [`La Cripta Olvidada vuelve a agitarse: cultistas y muertos surgen de sus profundidades. Desciende por las salas funerarias e informa, {playerName}.`, `Respiraste el aire de la cripta y viviste para contarlo. El Valle tiene suerte de que no cuentes entre sus muertos.`],
