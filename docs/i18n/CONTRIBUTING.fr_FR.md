...
# Contribuer à World of Warden

Avant tout, merci d'être là. World of Warden est construit par une communauté
...
clair, demandez sur [Discord](https://github.com/chriseg0996-star/world-of-warden-) et quelqu'un se fera un
...
- **Le code.** Corrigez un bug, ajoutez une fonctionnalité ou améliorez les
  ...
  et [`help wanted`](https://github.com/chriseg0996-star/world-of-warden-/labels/help%20wanted)
...
- **Les rapports de bugs et les idées de fonctionnalités.** Ouvrez un [ticket](https://github.com/chriseg0996-star/world-of-warden-/issues/new/choose).
...
World of Warden est disponible dans de nombreuses langues, et nous le gardons
...
terminologie, lancez un fil sur [Discord](https://github.com/chriseg0996-star/world-of-warden-) et nous vous
...
Merci d'utiliser les [modèles de ticket](https://github.com/chriseg0996-star/world-of-warden-/issues/new/choose) :

- **Rapport de bug.** Cherchez d'abord parmi les [tickets existants](https://github.com/chriseg0996-star/world-of-warden-/issues)
...
[Discord de la communauté](https://github.com/chriseg0996-star/world-of-warden-). Aucune question n'est trop
...
Merci de contribuer à World of Warden. Nous avons hâte de voir ce que vous
