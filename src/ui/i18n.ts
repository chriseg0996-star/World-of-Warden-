...
const phase1 = {
  en: {
    seo: {
      title: "Wardenfall: Classic-Style Web MMO",
      description: "Embark on an epic adventure in Wardenfall, a classic-style micro-MMO playable directly in your browser. Join a persistent shared realm, level up classes, and defeat enemies!",
      genre: "MMORPG",
    ...
    a11y: {
      ...
      githubProject: "Open the Wardenfall GitHub project",
      discordCommunity: "Join the Wardenfall Discord community",
      donateProject: "Donate to support Wardenfall",
    },
    loading: {
      world: "Loading world...",
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Open Wardenfall from the new Home Screen icon.",
      ...
      androidOpenStep: "Open Wardenfall from the new icon.",
    ...
    serverUnavailable: {
      title: "Wardenfall - Realm Unavailable",
      logoAlt: "Wardenfall",
  ...
  es: {
    seo: {
      title: "Wardenfall: MMO web de estilo clásico",
      description: "Emprende una aventura épica en Wardenfall, un micro-MMO de estilo clásico que se juega directamente en el navegador. Entra a un reino compartido, sube de nivel y derrota enemigos.",
      genre: "MMORPG",
    ...
    a11y: {
      ...
      githubProject: "Abrir el proyecto de Wardenfall en GitHub",
      discordCommunity: "Unirse a la comunidad de Wardenfall en Discord",
      donateProject: "Donar para apoyar Wardenfall",
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Abre Wardenfall desde el nuevo icono de la pantalla de inicio.",
      ...
      androidOpenStep: "Abre Wardenfall desde el nuevo icono.",
    ...
    serverUnavailable: {
      title: "Wardenfall - Reino no disponible",
      logoAlt: "Wardenfall",
  ...
  es_ES: {
    seo: {
      title: "Wardenfall: MMO web de estilo clásico",
      description: "Emprende una aventura épica en Wardenfall, un micro-MMO de estilo clásico jugable directamente en el navegador. Únete a un reino compartido, sube clases de nivel y derrota enemigos.",
      genre: "MMORPG",
      playMode: "Multijugador",
      applicationCategory: "Juego",
      operatingSystem: "Navegador web",
    ...
    a11y: {
      ...
      githubProject: "Abrir el proyecto Wardenfall en GitHub",
      discordCommunity: "Unirse a la comunidad de Wardenfall en Discord",
      donateProject: "Donar para apoyar Wardenfall",
    },
    loading: {
  ...
  fr_FR: {
    seo: {
      title: "Wardenfall: MMO web de style classique",
      description: "Partez pour une aventure épique dans Wardenfall, un micro-MMO au style classique jouable directement dans votre navigateur. Rejoignez un royaume persistant, progressez en classe et terrassez vos ennemis.",
      genre: "MMORPG",
    ...
    a11y: {
      ...
      githubProject: "Ouvrir le projet Wardenfall sur GitHub",
      discordCommunity: "Rejoindre la communauté Wardenfall sur Discord",
      donateProject: "Faire un don pour soutenir Wardenfall",
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Ouvrez Wardenfall depuis la nouvelle icône de l'écran d'accueil.",
      ...
      androidOpenStep: "Ouvrez Wardenfall depuis la nouvelle icône.",
    ...
    serverUnavailable: {
      title: "Wardenfall - Royaume indisponible",
      logoAlt: "Wardenfall",
  ...
  fr_CA: {
    seo: {
      title: "Wardenfall: MMO Web de style classique",
      description: "Partez à l'aventure dans Wardenfall, un micro-MMO de style classique jouable directement dans votre navigateur. Rejoignez un royaume partagé, faites progresser vos classes et terrassez des ennemis.",
      genre: "MMORPG",
      playMode: "Multijoueur",
      applicationCategory: "Jeu",
      operatingSystem: "Navigateur Web",
  ...
  it_IT: {
    seo: {
      title: "Wardenfall: MMO web in stile classico",
      description: "Parti per un'avventura epica in Wardenfall, un micro-MMO in stile classico giocabile direttamente dal browser. Entra in un reame condiviso, fai crescere le classi e sconfiggi i nemici.",
      genre: "MMORPG",
    ...
    a11y: {
      ...
      githubProject: "Apri il progetto Wardenfall su GitHub",
      discordCommunity: "Entra nella community Discord di Wardenfall",
      donateProject: "Fai una donazione per sostenere Wardenfall",
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Apri Wardenfall dalla nuova icona nella schermata Home.",
      ...
      androidOpenStep: "Apri Wardenfall dalla nuova icona.",
    ...
    serverUnavailable: {
      title: "Wardenfall - Reame non disponibile",
      logoAlt: "Wardenfall",
  ...
  de_DE: {
    seo: {
      title: "Wardenfall: Klassisches Web-MMO",
      description: "Begib dich in Wardenfall auf ein episches Abenteuer, ein Micro-MMO im klassischen Stil direkt im Browser. Betritt einen gemeinsamen Realm, steigere Klassen und besiege Gegner.",
      genre: "MMORPG",
    ...
    a11y: {
      ...
      githubProject: "Wardenfall-Projekt auf GitHub öffnen",
      discordCommunity: "Der Wardenfall-Community auf Discord beitreten",
      donateProject: "Spenden, um Wardenfall zu unterstützen",
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Öffne Wardenfall über das neue Symbol auf dem Home-Bildschirm.",
      ...
      androidOpenStep: "Öffne Wardenfall über das neue Symbol.",
    ...
    serverUnavailable: {
      title: "Wardenfall - Realm nicht verfügbar",
      logoAlt: "Wardenfall",
  ...
  zh_CN: {
    seo: {
      title: "Wardenfall：经典风格网页 MMO",
      description: "在 Wardenfall 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的服务器，提升职业等级，击败敌人。",
      genre: "MMORPG",
      playMode: "多人游戏",
    ...
    a11y: {
      ...
      githubProject: "打开 Wardenfall 的 GitHub 项目",
      discordCommunity: "加入 Wardenfall 的 Discord 社区",
      donateProject: "捐赠支持 Wardenfall",
    },
    loading: {
      world: "正在加载世界...",
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "从新的主屏幕图标打开 Wardenfall。",
  ...
  zh_TW: {
    seo: {
      title: "Wardenfall：經典風格網頁 MMO",
      description: "在 Wardenfall 展開史詩冒險。這是一款可直接在瀏覽器中遊玩的經典風格微型 MMO。加入持續共享的伺服器，提升職業等級並擊敗敵人。",
      genre: "MMORPG",
      playMode: "多人遊戲",
    ...
    a11y: {
      ...
      characterActions: "角色操作",
      githubProject: "開啟 Wardenfall 的 GitHub 專案",
      discordCommunity: "加入 Wardenfall 的 Discord 社群",
      donateProject: "捐贈支持 Wardenfall",
    },
    loading: {
      world: "正在載入世界...",
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "從新的主畫面圖示開啟 Wardenfall。",
  ...
  ko_KR: {
    seo: {
      title: "Wardenfall: 클래식 스타일 웹 MMO",
      description: "브라우저에서 바로 즐기는 클래식 스타일 마이크로 MMO, Wardenfall에서 장대한 모험을 시작하세요. 지속되는 공유 렐름에 접속해 직업을 성장시키고 적을 물리치세요.",
      genre: "MMORPG",
      playMode: "멀티플레이어",
    ...
    a11y: {
      ...
      githubProject: "GitHub에서 Wardenfall 프로젝트 열기",
      discordCommunity: "Wardenfall Discord 커뮤니티 참여",
      donateProject: "Wardenfall 후원하기",
    },
    loading: {
      world: "세계 불러오는 중...",
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "새 홈 화면 아이콘에서 Wardenfall를 여세요.",
  ...
  ja_JP: {
    seo: {
      title: "Wardenfall: クラシック風Web MMO",
      description: "ブラウザで直接遊べるクラシック風マイクロMMO、Wardenfall で壮大な冒険に出ましょう。永続的な共有レルムに参加し、クラスを育て、敵を倒してください。",
      genre: "MMORPG",
      playMode: "マルチプレイヤー",
    ...
    a11y: {
      ...
      githubProject: "GitHubでWardenfallプロジェクトを開く",
      discordCommunity: "WardenfallのDiscordコミュニティに参加",
      donateProject: "Wardenfallを支援するために寄付",
    },
    loading: {
      world: "世界を読み込み中...",
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "新しいホーム画面アイコンからWardenfallを開きます。",
  ...
  pt_BR: {
    seo: {
      title: "Wardenfall: MMO web em estilo clássico",
      description: "Embarque em uma aventura épica em Wardenfall, um micro-MMO de estilo clássico jogável diretamente no navegador. Entre em um reino compartilhado, evolua classes e derrote inimigos.",
      genre: "MMORPG",
    ...
    a11y: {
      ...
      githubProject: "Abrir o projeto Wardenfall no GitHub",
      discordCommunity: "Entrar na comunidade Wardenfall no Discord",
      donateProject: "Doar para apoiar Wardenfall",
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Abra Wardenfall pelo novo ícone na tela inicial.",
      ...
      androidOpenStep: "Abra Wardenfall pelo novo ícone.",
    ...
    serverUnavailable: {
      title: "Wardenfall - Reino indisponível",
      logoAlt: "Wardenfall",
  ...
  ru_RU: {
    seo: {
      title: "Wardenfall: веб-MMO в классическом стиле",
      description: "Отправьтесь в эпическое приключение в Wardenfall, микро-MMO в классическом стиле прямо в браузере. Присоединяйтесь к общему миру, развивайте классы и побеждайте врагов.",
      genre: "MMORPG",
    ...
    a11y: {
      ...
      githubProject: "Открыть проект Wardenfall на GitHub",
      discordCommunity: "Присоединиться к Discord-сообществу Wardenfall",
      donateProject: "Пожертвовать на поддержку Wardenfall",
    },
    loading: {
      world: "Загрузка мира...",
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Откройте Wardenfall через новый значок на домашнем экране.",
      ...
      androidOpenStep: "Откройте Wardenfall через новый значок.",
    ...
    serverUnavailable: {
      title: "Wardenfall - мир недоступен",
      logoAlt: "Wardenfall",
...
const phase2En = {
  hud: {
    ...
    options: {
      ...
      sectionInterface: "Display",
      sectionHud: "HUD",
      keyBindings: "Key Bindings",
      graphics: "Graphics",
      audio: "Audio",
      logout: "Logout",
      logoutConfirmTitle: "Leave the world?",
      logoutConfirmBody: "Return to the character screen?",
      ...
      graphicsNote: "Use Auto to match your hardware. Advanced unlocks terrain, foliage, effects, and shadow controls.",
      interfaceNote: "Lower Render Quality boosts FPS on weaker machines. Brightness tints the whole screen.",
      effectiveRenderScale: "Adaptive render scale active: {percent}%",
  ...
  es: {
    hud: {
      ...
      options: {
        ...
        sectionKeys: "Atajos de teclado",
        sectionGraphics: "Gráficos",
        sectionAdvanced: "Avanzado",
        sectionCamera: "Cámara",
        sectionInterface: "Pantalla",
        sectionHud: "HUD",
        keyBindings: "Atajos de teclado",
        graphics: "Gráficos",
        audio: "Audio",
        logout: "Cerrar sesión",
        logoutConfirmTitle: "¿Salir del mundo?",
        logoutConfirmBody: "¿Volver a la pantalla de personajes?",
      ...
      renderQuality: "Calidad de renderizado",
        ...
        graphicsNote: "Usa Auto para adaptarte a tu equipo. Avanzada desbloquea terreno, vegetación, efectos y sombras.",
        interfaceNote: "Una calidad de renderizado más baja mejora los FPS en equipos modestos. El brillo afecta toda la pantalla.",
        effectiveRenderScale: "Escala de renderizado adaptativa activa: {percent}%",
  ...
  fr_FR: {
    hud: {
      core: {
        ...
        menuHub: "Menus du jeu",
        menuHubClose: "Fermer les menus",
        emotes: "Émotes",
      },
      options: {
        ...
        invertMouseY: "Inverser l'axe Y de la souris",
        ...
        graphicsNote: "Auto s'adapte à votre matériel. Avancée débloque terrain, feuillage, effets et ombres.",
        interfaceNote: "Une qualité de rendu inférieure améliore les FPS. La luminosité affecte tout l'écran.",
        effectiveRenderScale: "Échelle de rendu adaptative active : {percent} %",
  ...
  it_IT: {
    hud: {
      core: {
        ...
        zoomIn: "Aumenta zoom",
        zoomOut: "Riduci zoom",
        menuHub: "Menu di gioco",
        menuHubClose: "Chiudi menu",
        emotes: "Emote",
      },
      options: {
        ...
        invertMouseY: "Inverti asse Y del mouse",
        ...
        graphicsNote: "Auto si adatta al tuo hardware. Avanzata sblocca terreno, vegetazione, effetti e ombre.",
        interfaceNote: "Una qualità di rendering più bassa migliora gli FPS. La luminosità influenza l'intero schermo.",
        effectiveRenderScale: "Scala di rendering adattiva attiva: {percent}%",
  ...
  de_DE: {
    hud: {
      ...
      options: {
        ...
        invertMouseY: "Maus-Y-Achse invertieren",
        ...
        graphicsNote: "Auto passt sich deiner Hardware an. Erweitert schaltet Gelände, Vegetation, Effekte und Schatten frei.",
        interfaceNote: "Niedrigere Renderqualität verbessert die FPS. Helligkeit färbt den gesamten Bildschirm.",
        effectiveRenderScale: "Adaptive Render-Skala aktiv: {percent} %",
  ...
  zh_CN: {
    hud: {
      ...
      options: {
        ...
        clickToMove: "点击移动",
        graphicsNote: "自动模式会匹配你的硬件。高级解锁地形、植被、特效与阴影控制。",
        interfaceNote: "降低渲染质量可提升帧率。亮度会影响整个画面。",
        effectiveRenderScale: "自适应渲染比例已启用：{percent}%",
        soundEffects: "音效",
        musicVolume: "音乐音量",
        music: "音乐",
  ...
  zh_TW: {
    hud: {
      ...
      options: {
        ...
        clickToMove: "點擊移動",
        graphicsNote: "自動模式會配合你的硬體。進階解鎖地形、植被、特效與陰影控制。",
        interfaceNote: "降低渲染品質可提升幀率。亮度會影響整個畫面。",
        effectiveRenderScale: "自適應渲染比例已啟用：{percent}%",
        soundEffects: "音效",
        musicVolume: "音樂音量",
        music: "音樂",
  ...
  ko_KR: {
    hud: {
      ...
      options: {
        ...
        clickToMove: "클릭하여 이동",
        graphicsNote: "자동은 하드웨어에 맞춥니다. 고급에서 지형, 식생, 효과, 그림자를 조절할 수 있습니다.",
        interfaceNote: "렌더 품질을 낮추면 FPS가 향상됩니다. 밝기는 화면 전체에 적용됩니다.",
        effectiveRenderScale: "적응형 렌더 배율 적용 중: {percent}%",
        soundEffects: "효과음",
        musicVolume: "음악 음량",
        music: "음악",
  ...
  ja_JP: {
    hud: {
      ...
      options: {
        ...
        clickToMove: "クリック移動",
        graphicsNote: "自動はハードウェアに合わせます。詳細で地形、植被、エフェクト、影を調整できます。",
        interfaceNote: "描画品質を下げるとFPSが向上します。明るさは画面全体に影響します。",
        effectiveRenderScale: "適応レンダースケール作動中: {percent}%",
        soundEffects: "効果音",
        musicVolume: "音楽音量",
        music: "音楽",
  ...
  pt_BR: {
    hud: {
      core: {
        ...
        zoomIn: "Aproximar",
        zoomOut: "Afastar",
        menuHub: "Menus do jogo",
        menuHubClose: "Fechar menus",
        emotes: "Emotes",
      },
      options: {
        ...
        invertMouseY: "Inverter eixo Y do mouse",
        brightness: "Brilho",
        ...
        graphicsNote: "Auto adapta-se ao seu hardware. Avançada libera terreno, vegetação, efeitos e sombras.",
        interfaceNote: "Qualidade de renderização mais baixa melhora o FPS. O brilho afeta a tela inteira.",
        effectiveRenderScale: "Escala de renderização adaptativa ativa: {percent}%",
  ...
  ru_RU: {
    hud: {
      core: {
        ...
        zoomIn: "Приблизить",
        zoomOut: "Отдалить",
        menuHub: "Игровые меню",
        menuHubClose: "Закрыть меню",
        emotes: "Эмоции",
      },
      options: {
        gameMenu: "Меню игры",
        ...
        invertMouseY: "Инвертировать ось Y мыши",
        brightness: "Яркость",
        ...
        graphicsNote: "Авто подстраивается под железо. Расширенные настройки открывают рельеф, растительность, эффекты и тени.",
        interfaceNote: "Более низкое качество рендера повышает FPS. Яркость влияет на весь экран.",
        effectiveRenderScale: "Активна адаптивная шкала рендера: {percent}%",
...
const phase3En = {
  abilityUi: {
    ...
    spellbook: {
      ...
      sectionKnown: "Known",
      sectionTrainable: "Trainable",
      learnedCount: "{known} / {total} learned",
      dragHint: "Drag to your action bar to assign.",
    },
    tooltip: {
      rank: "Rank {rank}",
      cost: "{cost} {resource}",
  ...
  es: {
    abilityUi: {
      ...
      spellbook: {
        ...
        sectionKnown: "Conocidos",
        sectionTrainable: "Entrenables",
        learnedCount: "{known} / {total} aprendidos",
        dragHint: "Arrastra a tu barra de acción para asignar.",
      },
      tooltip: {
        rank: "Rango {rank}",
  ...
  fr_FR: {
    abilityUi: {
      ...
      spellbook: {
        ...
        sectionKnown: "Connues",
        sectionTrainable: "À apprendre",
        learnedCount: "{known} / {total} apprises",
        dragHint: "Faites glisser vers votre barre d'actions pour assigner.",
      },
      tooltip: {
        rank: "Rang {rank}",
        cost: "{cost} {resource}",
  ...
  it_IT: {
    abilityUi: {
      ...
      spellbook: {
        ...
        sectionKnown: "Conosciute",
        sectionTrainable: "Apprendibili",
        learnedCount: "{known} / {total} apprese",
        dragHint: "Trascina sulla barra delle azioni per assegnare.",
      },
      tooltip: {
        rank: "Grado {rank}",
        cost: "{cost} {resource}",
  ...
  de_DE: {
    abilityUi: {
      ...
      spellbook: {
        ...
        sectionKnown: "Bekannt",
        sectionTrainable: "Erlernbar",
        learnedCount: "{known} / {total} erlernt",
        dragHint: "Zum Zuweisen auf die Aktionsleiste ziehen.",
      },
      tooltip: {
        rank: "Rang {rank}",
        cost: "{cost} {resource}",
  ...
  zh_CN: {
    abilityUi: {
      ...
      spellbook: {
        ...
        empty: "没有可用技能。",
        sectionKnown: "已学会",
        sectionTrainable: "可学习",
        learnedCount: "已学 {known} / {total}",
        dragHint: "拖到动作条以绑定。",
      },
      tooltip: {
        rank: "等级 {rank}",
  ...
  zh_TW: {
    abilityUi: {
      ...
      spellbook: {
        ...
        empty: "沒有可用技能。",
        sectionKnown: "已學會",
        sectionTrainable: "可學習",
        learnedCount: "已學 {known} / {total}",
        dragHint: "拖到動作列以綁定。",
      },
      tooltip: {
        rank: "等級 {rank}",
  ...
  ko_KR: {
    abilityUi: {
      ...
      spellbook: {
        ...
        sectionKnown: "습득함",
        sectionTrainable: "습득 가능",
        learnedCount: "{known} / {total} 습득",
        dragHint: "행동 단축바로 끌어다 놓아 배치하세요.",
      },
      tooltip: {
        rank: "{rank} 등급",
        cost: "{resource} {cost}",
  ...
  ja_JP: {
    abilityUi: {
      ...
      spellbook: {
        ...
        empty: "利用できる能力がありません。",
        sectionKnown: "習得済み",
        sectionTrainable: "習得可能",
        learnedCount: "{known} / {total} 習得",
        dragHint: "アクションバーへドラッグして配置。",
      },
      tooltip: {
        rank: "ランク{rank}",
        cost: "{resource} {cost}",
  ...
  pt_BR: {
    abilityUi: {
      ...
      spellbook: {
        ...
        sectionKnown: "Conhecidas",
        sectionTrainable: "Aprendíveis",
        learnedCount: "{known} / {total} aprendidas",
        dragHint: "Arraste para a barra de ação para atribuir.",
      },
      tooltip: {
        rank: "Grau {rank}",
        cost: "{cost} de {resource}",
  ...
  ru_RU: {
    abilityUi: {
      ...
      spellbook: {
        ...
        sectionKnown: "Изучено",
        sectionTrainable: "Доступно",
        learnedCount: "{known} / {total} изучено",
        dragHint: "Перетащите на панель действий, чтобы назначить.",
      },
      tooltip: {
        rank: "Ранг {rank}",
        cost: "{cost} {resource}",
...
const phase5En = {
  itemUi: {
    ...
    set: {
      ...
      wolfRunner: 'Wolf Runner',
      fenwalker: 'Fenwalker',
      cragwalker: 'Cragwalker',
    },
    quality: {
      poor: "Poor",
      common: "Common",
    ...
    tooltip: {
      ...
      compareDps: "({delta} damage per second)",
      compareStat: "{sign}{value} {stat}",
    ...
    equipment: {
      ...
      chromaList: "Character appearance",
      chromaOption: "Appearance {index}",
      tabCharacter: "Character",
      tabStats: "Stats",
      tabProgression: "Progression",
      statsPrimary: "Attributes",
      statsCombat: "Combat",
    },
    vendor: {
...
const phase5 = {
  ...
  es: {
    itemUi: {
      ...
      set: { header: "{name} ({have}/{total})", tier: "({pieces}) {bonus}", recruitVigil: "Vigilia del Recluta", wolfRunner: "Corredor del Lobo", fenwalker: "Caminante del Pantano", cragwalker: "Caminante del Peñasco" },
      ...
      stats: { armor: "Armadura", str: "Fuerza", agi: "Agilidad", sta: "Aguante", int: "Intelecto", spi: "Espíritu", attackPower: "Poder de ataque", dps: "Daño/seg", critChance: "Prob. de crítico", dodge: "Esquiva", critStrike: "Golpe crítico", maxHealth: "Salud máxima" },
      tooltip: {
        ...
        compareDps: "({delta} de daño por segundo)", compareStat: "{sign}{value} {stat}",
      ...
      equipment: { empty: "Vacío", levelClass: "Nivel {level} {className}", activate: "Activar {name}", chromaList: "Apariencia del personaje", chromaOption: "Apariencia {index}", tabCharacter: "Personaje", tabStats: "Estadísticas", tabProgression: "Progresión", statsPrimary: "Atributos", statsCombat: "Combate" },
  ...
  fr_FR: {
    itemUi: {
      ...
      set: { header: "{name} ({have}/{total})", tier: "({pieces}) {bonus}", recruitVigil: "Vigile de la Recrue", wolfRunner: "Coureur du Loup", fenwalker: "Marcheur des Fanges", cragwalker: "Marcheur des Crêtes" },
      ...
      stats: { armor: "Armure", str: "Force", agi: "Agilité", sta: "Endurance", int: "Intelligence", spi: "Esprit", attackPower: "Puissance d'attaque", dps: "Dégâts/s", critChance: "Chances de critique", dodge: "Esquive", critStrike: "Coup critique" },
      tooltip: {
        ...
        compareDps: "({delta} dégâts par seconde)", compareStat: "{sign}{value} {stat}",
      ...
      equipment: { empty: "Vide", levelClass: "Niveau {level} {className}", activate: "Activer {name}", chromaList: "Apparence du personnage", chromaOption: "Apparence {index}", tabCharacter: "Personnage", tabStats: "Statistiques", tabProgression: "Progression", statsPrimary: "Attributs", statsCombat: "Combat" },
  ...
  it_IT: {
    itemUi: {
      ...
      set: { header: "{name} ({have}/{total})", tier: "({pieces}) {bonus}", recruitVigil: "Veglia della Recluta", wolfRunner: "Corridore del Lupo", fenwalker: "Camminatore della Palude", cragwalker: "Camminatore del Dirupo" },
      ...
      stats: { armor: "Armatura", str: "Forza", agi: "Agilità", sta: "Tempra", int: "Intelletto", spi: "Spirito", attackPower: "Potenza d'attacco", dps: "Danni/sec", critChance: "Prob. critico", dodge: "Schivata", critStrike: "Colpo critico" },
      tooltip: {
        ...
        compareDps: "({delta} danni al secondo)", compareStat: "{sign}{value} {stat}",
      ...
      equipment: { empty: "Vuoto", levelClass: "Livello {level} {className}", activate: "Attiva {name}", chromaList: "Aspetto del personaggio", chromaOption: "Aspetto {index}", tabCharacter: "Personaggio", tabStats: "Statistiche", tabProgression: "Progressione", statsPrimary: "Attributi", statsCombat: "Combattimento" },
  ...
  de_DE: {
    itemUi: {
      ...
      set: { header: "{name} ({have}/{total})", tier: "({pieces}) {bonus}", recruitVigil: "Wacht des Rekruten", wolfRunner: "Wolfsläufer", fenwalker: "Fenwanderer", cragwalker: "Felswanderer" },
      ...
      stats: { armor: "Rüstung", str: "Stärke", agi: "Beweglichkeit", sta: "Ausdauer", int: "Intelligenz", spi: "Willenskraft", attackPower: "Angriffskraft", dps: "Schaden/Sek.", critChance: "Krit. Chance", dodge: "Ausweichen", critStrike: "Kritischer Treffer" },
      tooltip: {
        ...
        compareDps: "({delta} Schaden pro Sekunde)", compareStat: "{sign}{value} {stat}",
      ...
      equipment: { empty: "Leer", levelClass: "Stufe {level} {className}", activate: "{name} aktivieren", chromaList: "Charakteraussehen", chromaOption: "Aussehen {index}", tabCharacter: "Charakter", tabStats: "Werte", tabProgression: "Fortschritt", statsPrimary: "Attribute", statsCombat: "Kampf" },
  ...
  zh_CN: {
    itemUi: {
      ...
      set: { header: "{name} ({have}/{total})", tier: "({pieces}) {bonus}", recruitVigil: "新兵的守望", wolfRunner: "奔狼行者", fenwalker: "沼地行者", cragwalker: "峭壁行者" },
      ...
      stats: { armor: "护甲", str: "力量", agi: "敏捷", sta: "耐力", int: "智力", spi: "精神", attackPower: "攻击强度", dps: "每秒伤害", critChance: "暴击几率", dodge: "躲闪", critStrike: "暴击" },
      tooltip: {
        ...
        compareDps: "（{delta} 每秒伤害）", compareStat: "{sign}{value} {stat}",
      ...
      equipment: { empty: "空", levelClass: "{level} 级 {className}", activate: "激活{name}", chromaList: "角色外观", chromaOption: "外观 {index}", tabCharacter: "角色", tabStats: "属性", tabProgression: "进度", statsPrimary: "基础属性", statsCombat: "战斗" },
  ...
  zh_TW: {
    itemUi: {
      ...
      stats: { armor: "護甲", str: "力量", agi: "敏捷", sta: "耐力", int: "智力", spi: "精神", attackPower: "攻擊強度", dps: "每秒傷害", critChance: "爆擊機率", dodge: "閃躲", critStrike: "致命一擊" },
      tooltip: {
        ...
        compareDps: "（{delta} 每秒傷害）", compareStat: "{sign}{value} {stat}",
      ...
      equipment: { empty: "空", levelClass: "{level} 級 {className}", activate: "啟動{name}", chromaList: "角色外觀", chromaOption: "外觀 {index}", tabCharacter: "角色", tabStats: "屬性", tabProgression: "進度", statsPrimary: "基礎屬性", statsCombat: "戰鬥" },
  ...
  ko_KR: {
    itemUi: {
      ...
      set: { header: "{name} ({have}/{total})", tier: "({pieces}) {bonus}", recruitVigil: "신병의 경계", wolfRunner: "늑대 질주자", fenwalker: "습지 방랑자", cragwalker: "암벽 방랑자" },
      ...
      stats: { armor: "방어도", str: "힘", agi: "민첩성", sta: "체력", int: "지능", spi: "정신력", attackPower: "전투력", dps: "초당 피해", critChance: "치명타율", dodge: "회피", critStrike: "치명타" },
      tooltip: {
        ...
        compareDps: "({delta} 초당 피해)", compareStat: "{sign}{value} {stat}",
      ...
      equipment: { empty: "비어 있음", levelClass: "{level}레벨 {className}", activate: "{name} 사용", chromaList: "캐릭터 외형", chromaOption: "외형 {index}", tabCharacter: "캐릭터", tabStats: "능력치", tabProgression: "진행", statsPrimary: "기본 능력", statsCombat: "전투" },
  ...
  ja_JP: {
    itemUi: {
      ...
      set: { header: "{name} ({have}/{total})", tier: "({pieces}) {bonus}", recruitVigil: "新兵の警戒", wolfRunner: "ウルフランナー", fenwalker: "フェンウォーカー", cragwalker: "クラッグウォーカー" },
      quality: { poor: "粗悪", common: "一般", uncommon: "良質", rare: "レア", epic: "エピック", legendary: "伝説" },
      kind: { weapon: "武器", armor: "防具", quest: "クエストアイテム", junk: "雑貨", food: "食べ物", drink: "飲み物" },
      stats: { armor: "防御力", str: "筋力", agi: "敏捷性", sta: "スタミナ", int: "知力", spi: "精神力", attackPower: "攻撃力", dps: "秒間ダメージ", critChance: "クリティカル率", dodge: "回避", critStrike: "クリティカル" },
      tooltip: {
        ...
        compareDps: "（{delta} 秒間ダメージ）", compareStat: "{sign}{value} {stat}",
      ...
      equipment: { empty: "空", levelClass: "レベル{level} {className}", activate: "{name}を使用", chromaList: "キャラクターの外見", chromaOption: "外見 {index}", tabCharacter: "キャラクター", tabStats: "ステータス", tabProgression: "進行", statsPrimary: "基本能力", statsCombat: "戦闘" },
  ...
  pt_BR: {
    itemUi: {
      ...
      set: { header: "{name} ({have}/{total})", tier: "({pieces}) {bonus}", recruitVigil: "Vigília do Recruta", wolfRunner: "Corredor do Lobo", fenwalker: "Caminhante do Pântano", cragwalker: "Caminhante do Penhasco" },
      ...
      stats: { armor: "Armadura", str: "Força", agi: "Agilidade", sta: "Vigor", int: "Intelecto", spi: "Espírito", attackPower: "Poder de ataque", dps: "Dano/s", critChance: "Chance crítica", dodge: "Esquiva", critStrike: "Golpe crítico" },
      tooltip: {
        ...
        compareDps: "({delta} de dano por segundo)", compareStat: "{sign}{value} {stat}",
      ...
      equipment: { empty: "Vazio", levelClass: "Nível {level} {className}", activate: "Ativar {name}", chromaList: "Aparência do personagem", chromaOption: "Aparência {index}", tabCharacter: "Personagem", tabStats: "Atributos", tabProgression: "Progressão", statsPrimary: "Atributos", statsCombat: "Combate" },
  ...
  ru_RU: {
    itemUi: {
      ...
      set: { header: "{name} ({have}/{total})", tier: "({pieces}) {bonus}", recruitVigil: "Бдение новобранца", wolfRunner: "Волкобег", fenwalker: "Топеход", cragwalker: "Скалолаз" },
      ...
      stats: { armor: "Броня", str: "Сила", agi: "Ловкость", sta: "Выносливость", int: "Интеллект", spi: "Дух", attackPower: "Сила атаки", dps: "Урон/сек", critChance: "Шанс крита", dodge: "Уклонение", critStrike: "Критический удар" },
      tooltip: {
        ...
        compareDps: "({delta} урона в секунду)", compareStat: "{sign}{value} {stat}",
      ...
      equipment: { empty: "Пусто", levelClass: "Уровень {level} {className}", activate: "Активировать {name}", chromaList: "Внешний вид персонажа", chromaOption: "Внешность {index}", tabCharacter: "Персонаж", tabStats: "Характеристики", tabProgression: "Прогресс", statsPrimary: "Атрибуты", statsCombat: "Бой" },
...
const ITEM_ENTITY_IDS = [
  ...
  "webwood_silk", "supply_crate", "greyjaw_fang", "weathered_ledger_page", "morthen_grimoire", "wolf_pelt", "wolf_fang", "bandit_bandana",
  ...
  "initiate_hammer", "training_crossbow", "novice_staff", "spirit_staff", "forbidden_tome", "woodland_staff",
  "wolf_fang_blade", "wolfhide_gloves", "wolf_runner_boots", "bandit_cudgel", "road_scout_coif", "pilfered_chain_vest",
  "crypt_blade", "bone_shield", "cultist_robes", "ancient_ring", "wardens_hammer",
] as const;
...
const phase8En = {
  ...
  entities: {
    ...
    items: itemTranslations([
      "Rusty Sword", "Apprentice Staff", "Worn Daggers", "Training Mace", "Rusty Hatchet", "Recruit's Tunic", "Apprentice's Robe", "Footpad's Jerkin",
      ...
      "Old Greyjaw's Fang", "Weathered Ledger Page", "Morthen's Grimoire", "Wolf Pelt", "Cracked Wolf Fang", "Red Bandana", "Tough Jerky", "Slimy Murloc Scale", "Tallow Candle",
      ...
      "Recruit's Hourglass", "Coin of Fortune",
      "Initiate Hammer", "Training Crossbow", "Novice Staff", "Spirit Staff", "Forbidden Tome", "Woodland Staff",
      "Wolf Fang Blade", "Wolfhide Gloves", "Wolf Runner Boots", "Bandit Cudgel", "Road Scout Coif", "Pilfered Chain Vest",
      "Crypt Blade", "Bone Shield", "Cultist Robes", "Ancient Ring", "Warden's Hammer",
    ]),
  },
};
  ...
  es: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Colmillo del viejo Greyjaw", "Página de libro mayor ajada", "Grimorio de Morthen", "Piel de lobo", "Colmillo de lobo quebrado", "Pañuelo rojo", "Cecina dura", "Escama viscosa de múrloc", "Vela de sebo",
        ...
        "Reloj de arena del recluta", "Moneda de la fortuna",
        "Martillo del iniciado", "Ballesta de entrenamiento", "Bastón del novicio", "Bastón espiritual", "Tomo prohibido", "Bastón del bosque",
        "Hoja de colmillo de lobo", "Guantes de piel de lobo", "Botas del corredor lobo", "Porra de bandido", "Cofia del explorador del camino", "Chaleco de cota robado",
        "Hoja de la cripta", "Escudo de hueso", "Togas del cultista", "Anillo antiguo", "Martillo del guardián",
      ]),
    },
  },
  ...
  fr_FR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Croc du vieux Greyjaw", "Page de registre usée", "Grimoire de Morthen", "Peau de loup", "Croc de loup fendu", "Bandana rouge", "Viande séchée coriace", "Écaille de murloc visqueuse", "Chandelle de suif",
        ...
        "Sablier de la recrue", "Pièce de la fortune",
        "Marteau d'initié", "Arbalète d'entraînement", "Bâton de novice", "Bâton spirituel", "Tome interdit", "Bâton des bois",
        "Lame de croc de loup", "Gants en peau de loup", "Bottes du coureur loup", "Gourdin de bandit", "Coiffe d'éclaireur des routes", "Gilet de mailles volé",
        "Lame de la crypte", "Bouclier d'os", "Robes de cultiste", "Anneau ancien", "Marteau du gardien",
      ]),
    },
  },
  ...
  it_IT: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Zanna del vecchio Greyjaw", "Pagina di registro logora", "Grimorio di Morthen", "Pelle di lupo", "Zanna di lupo incrinata", "Bandana rossa", "Carne secca dura", "Scaglia viscida di murloc", "Candela di sego",
        ...
        "Clessidra della recluta", "Moneta della fortuna",
        "Martello dell'iniziato", "Balestra da addestramento", "Bastone del novizio", "Bastone spirituale", "Tomo proibito", "Bastone del bosco",
        "Lama di zanna di lupo", "Guanti di pelle di lupo", "Stivali del corridore lupo", "Randello da bandito", "Cuffia da esploratore della strada", "Giubba di maglia rubata",
        "Lama della cripta", "Scudo d'ossa", "Vesti del cultista", "Anello antico", "Martello del custode",
      ]),
    },
  },
  de_DE: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Zahn des alten Greyjaw", "Verwitterte Buchseite", "Morthens Grimoire", "Wolfspelz", "Gesprungener Wolfszahn", "Rotes Halstuch", "Zähes Dörrfleisch", "Schleimige Murlocschuppe", "Talgkerze",
        ...
        "Sanduhr des Rekruten", "Münze des Glücks",
        "Initiatenhammer", "Übungsarmbrust", "Novizenstab", "Geisterstab", "Verbotenes Foliant", "Waldlandstab",
        "Wolfzahnklinge", "Wolfshandschuhe", "Wolfläuferstiefel", "Banditenknüppel", "Straßenspäherhaube", "Gestohlene Kettenweste",
        "Kryptaklinge", "Knochenschild", "Kultistenroben", "Uralter Ring", "Hammer des Wärters",
      ]),
    },
  },
  zh_CN: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "老灰颚的尖牙", "风化账页", "莫森的魔典", "狼皮", "裂开的狼牙", "红色面巾", "硬肉干", "黏滑鱼人鳞片", "油脂蜡烛",
        ...
        "新兵的沙漏", "幸运硬币",
        "新兵之锤", "训练用弩", "新手法杖", "灵契法杖", "禁断魔典", "林地法杖",
        "狼牙之刃", "狼皮手套", "奔狼之靴", "强盗棍棒", "巡路斥候头巾", "赃物链甲背心",
        "墓穴之刃", "骨盾", "教徒长袍", "古戒", "守墓人之锤",
      ]),
    },
  },
  zh_TW: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "老灰顎的尖牙", "風化帳頁", "莫森的魔典", "狼皮", "裂開的狼牙", "紅色面巾", "硬肉乾", "黏滑魚人鱗片", "油脂蠟燭",
        ...
        "新兵的沙漏", "幸運硬幣",
        "新兵之錘", "訓練用弩", "新手法杖", "靈契法杖", "禁斷魔典", "林地法杖",
        "狼牙之刃", "狼皮手套", "奔狼之靴", "強盜棍棒", "巡路斥候頭巾", "贓物鏈甲背心",
        "墓穴之刃", "骨盾", "教徒長袍", "古戒", "守墓人之錘",
      ]),
    },
  },
  ko_KR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "늙은 그레이죠의 송곳니", "풍화된 장부 페이지", "모르덴의 마법서", "늑대 가죽", "갈라진 늑대 송곳니", "붉은 두건", "질긴 육포", "끈적한 멀록 비늘", "수지 양초",
        ...
        "신병의 모래시계", "행운의 동전",
        "입문자의 망치", "훈련용 석궁", "초보 사제의 지팡이", "영혼의 지팡이", "금서", "숲지팡이",
        "늑대 송곳니 검", "늑대가죽 장갑", "늑대질주 장화", "산적 곤봉", "길 정찰 두건", "훔친 사슬 조끼",
        "무덤 검", "뼈 방패", "교도복", "고대 반지", "관문인의 망치",
      ]),
    },
  },
  ja_JP: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "老グレイジョーの牙", "風化した帳簿のページ", "モーセンの魔導書", "狼の毛皮", "割れた狼の牙", "赤いバンダナ", "硬い干し肉", "ぬめるマーロックの鱗", "獣脂のろうそく",
        ...
        "新兵の砂時計", "幸運のコイン",
        "見習いのハンマー", "訓練用クロスボウ", "新米の杖", "精霊の杖", "禁断の書", "森の杖",
        "狼牙の刃", "狼皮の手袋", "狼走りのブーツ", "盗賊の棍棒", "街道斥候の頭巾", "盗まれた鎖帷子ベスト",
        "墓穴の刃", "骨の盾", "教徒のローブ", "古の指輪", "番人のハンマー",
      ]),
    },
  },
  pt_BR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Presa do velho Greyjaw", "Página de livro-caixa gasta", "Grimório de Morthen", "Pele de lobo", "Presa de lobo rachada", "Bandana vermelha", "Charque duro", "Escama viscosa de murloc", "Vela de sebo",
        ...
        "Ampulheta do recruta", "Moeda da fortuna",
        "Martelo do iniciado", "Besta de treino", "Cajado do noviço", "Cajado espiritual", "Tomo proibido", "Cajado da floresta",
        "Lâmina de presa de lobo", "Luvas de pele de lobo", "Botas do corredor lobo", "Porrete de bandido", "Coifa do batedor da estrada", "Colete de cota roubado",
        "Lâmina da cripta", "Escudo de osso", "Vestes do cultista", "Anel antigo", "Martelo do guardião",
      ]),
    },
  },
  ru_RU: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Клык старого Серочелюста", "Выветренная страница книги учета", "Гримуар Мортена", "Волчья шкура", "Треснувший волчий клык", "Красная бандана", "Жесткое вяленое мясо", "Слизистая чешуя мурлока", "Сальная свеча",
        ...
        "Песочные часы новобранца", "Монета удачи",
        "Молот посвящённого", "Учебный арбалет", "Посох новичка", "Посох духов", "Запретный фолиант", "Лесной посох",
        "Клинок волчьего клыка", "Волчьи перчатки", "Сапоги волчьего бегуна", "Дубинка разбойника", "Койф дорожного разведчика", "Украденный кольчужный жилет",
        "Клинок склепа", "Костяной щит", "Одеяния культиста", "Древнее кольцо", "Молот хранителя",
      ]),
    },
  },
};
...
const phase11En = {
  ...
  itemUi: {
    ...
    tooltip: {
      ...
      useTrinket: "Use: +{value} {stat} for {seconds} sec. {cooldown} sec cooldown.",
      proc: "Chance on hit: +{value} {stat} for {seconds} sec ({chance}%).",
  ...
  es: {
    ...
    itemUi: {
      ...
      tooltip: {
        ...
        useTrinket: "Uso: +{value} {stat} durante {seconds} s. Reutilización de {cooldown} s.",
        proc: "Probabilidad al golpear: +{value} {stat} durante {seconds} s ({chance}%).",
  ...
  fr_FR: {
    ...
    itemUi: {
      ...
      tooltip: {
        ...
        useTrinket: "Utiliser : +{value} {stat} pendant {seconds} s. Recharge de {cooldown} s.",
        proc: "Chance au toucher : +{value} {stat} pendant {seconds} s ({chance} %).",
  ...
  it_IT: {
    ...
    itemUi: {
      ...
      tooltip: {
        ...
        useTrinket: "Usa: +{value} {stat} per {seconds} s. Recupero {cooldown} s.",
        proc: "Probabilità al colpo: +{value} {stat} per {seconds} s ({chance}%).",
  ...
  de_DE: {
    ...
    itemUi: {
      ...
      tooltip: {
        ...
        useTrinket: "Benutzen: +{value} {stat} für {seconds} Sek. {cooldown} Sek. Abklingzeit.",
        proc: "Chance bei Treffer: +{value} {stat} für {seconds} Sek. ({chance}%).",
  ...
  zh_CN: {
    ...
    itemUi: {
      ...
      tooltip: {
        ...
        useTrinket: "使用：{seconds} 秒内 +{value} {stat}。冷却 {cooldown} 秒。",
        proc: "击中时有几率：{seconds} 秒内 +{value} {stat}（{chance}%）。",
  ...
  zh_TW: {
    ...
    itemUi: {
      ...
      tooltip: {
        ...
        useTrinket: "使用：{seconds} 秒內 +{value} {stat}。冷卻 {cooldown} 秒。",
        proc: "擊中時有機率：{seconds} 秒內 +{value} {stat}（{chance}%）。",
  ...
  ko_KR: {
    ...
    itemUi: {
      ...
      tooltip: {
        ...
        useTrinket: "사용: {seconds}초 동안 +{value} {stat}. 재사용 대기시간 {cooldown}초.",
        proc: "공격 적중 시 확률: {seconds}초 동안 +{value} {stat} ({chance}%).",
  ...
  ja_JP: {
    ...
    itemUi: {
      ...
      tooltip: {
        ...
        useTrinket: "使用: {seconds}秒間 +{value} {stat}。クールダウン{cooldown}秒。",
        proc: "命中時に確率で: {seconds}秒間 +{value} {stat}（{chance}%）。",
  ...
  pt_BR: {
    ...
    itemUi: {
      ...
      tooltip: {
        ...
        useTrinket: "Uso: +{value} {stat} por {seconds} s. Recarga de {cooldown} s.",
        proc: "Chance ao acertar: +{value} {stat} por {seconds} s ({chance}%).",
  ...
  ru_RU: {
    ...
    itemUi: {
      ...
      tooltip: {
        ...
        useTrinket: "Использование: +{value} {stat} на {seconds} с. Восстановление {cooldown} с.",
        proc: "Шанс при попадании: +{value} {stat} на {seconds} с ({chance}%).",
...
export const gameStrings = {
  ...
  settings: {
    ...
    showNameplates: "Show Nameplates",
  },
  charPane: {
    setsTitle: "Item Sets",
    weaponDamage: "Weapon damage",
    weaponDamageValue: "{min}–{max}",
    weaponSpeed: "Weapon speed",
    weaponSpeedValue: "{seconds}s",
    damageReduction: "Physical damage reduction",
    healthRegen: "Health per 5 s (resting)",
    manaRegen: "Mana per 5 s (out of combat)",
    equipPickerEmpty: "Nothing in your bags fits this slot.",
    unequip: "Unequip",
  },
  questLog: {
    track: "Track on screen",
    untrack: "Stop tracking",
    showOnMap: "Show on map",
    noPin: "No map location is known for this quest.",
  },
  bags: {
    searchPlaceholder: "Search bags",
    searchAria: "Search your bags",
    sort: "Sort",
    sortAria: "Sort items by type and quality",
    noMatches: "No items match your search.",
    ctxEquip: "Equip",
    ctxUse: "Use",
    ctxSellOne: "Sell",
    ctxSellStack: "Sell stack ({count})",
    ctxSellSome: "Sell a quantity…",
    ctxTrade: "Add to trade",
    ctxMarket: "Choose for listing",
    ctxDestroy: "Destroy…",
    ctxCancel: "Cancel",
  },
  emotes: {
  ...
  talents: {
    ...
    revertChanges: "Discard changes",
    unsaved: "Unsaved changes",
    shapeLegend: "Square = active ability · Circle = passive · Octagon = choice",
    legendActive: "Active ability",
    legendPassive: "Passive",
    legendChoice: "Choice node",
    controlsTitle: "Controls",
    apply: "Apply changes",
    clear: "Reset points",
    reset: "Reset",
    chooseSpec: "Choose a Specialization",
    specTree: "Specialization tree",
    ...
    charPoints: "{available} of {total} talent points available ({spent} spent)",
    investedHeading: "Invested talents",
    noTalentsInvested: "No talents invested yet",
    investedRank: "{name} — Rank {rank}/{max}",
    copy: "Copy",
    close: "Close",
    cancel: "Cancel",
  ...
  loot: {
    lootMoneyAria: "Loot {money}",
    lootItemAria: "Loot {item}",
    rollAria: "Group loot roll for {item}",
    need: "Need",
    greed: "Greed",
    pass: "Pass",
    needAria: "Roll Need on {item}",
    greedAria: "Roll Greed on {item}",
    passAria: "Pass on {item}",
  },
  vendor: {
    shiftBuyHint: "Shift-click to buy a quantity",
    sellJunk: "Sell junk ({money})",
    sellJunkAria: "Sell all poor-quality items for {money}",
    buyQtyTitle: "Buy how many {item}?",
    buyQtyInput: "Quantity to buy",
    buyQtyConfirm: "Buy",
    buyQtyCancel: "Cancel",
  },
  market: {
    searchPlaceholder: "Search listings",
    searchAria: "Search market listings",
    ...
    sortUnit: "Price per unit",
    noMatches: "No listings match your search.",
  },
  spellbook: {
    searchPlaceholder: "Search spells",
    searchAria: "Search your spellbook",
    noMatches: "No spells match your search.",
    nextRank: "Next rank at level {level}",
  },
  social: {
    whoTab: "Who",
    whoLoading: "Looking up who is online…",
    whoEmpty: "No one else is online right now.",
    whoCount: "{count} players online",
    whoMore: "…and {count} more.",
    whoRefresh: "Refresh",
    motdLabel: "MOTD",
    motdEmpty: "No message of the day set.",
    motdEditAria: "Edit the guild message of the day",
    motdPromptTitle: "Set the guild message of the day (leave empty to clear):",
    motdPlaceholder: "Message of the day",
    motdSave: "Save",
  },
};
...
const gameStringsEs: typeof gameStrings = {
  ...
  settings: { showOverflowXp: "Mostrar EXP excedente", showNameplates: "Mostrar placas de nombre" },
  charPane: {
    setsTitle: "Conjuntos de objetos",
    weaponDamage: "Daño del arma",
    weaponDamageValue: "{min}–{max}",
    weaponSpeed: "Velocidad del arma",
    weaponSpeedValue: "{seconds} s",
    damageReduction: "Reducción de daño físico",
    healthRegen: "Salud cada 5 s (descansando)",
    manaRegen: "Maná cada 5 s (fuera de combate)",
    equipPickerEmpty: "Nada en tus bolsas encaja en este espacio.",
    unequip: "Desequipar",
  },
  questLog: {
    track: "Rastrear en pantalla",
    untrack: "Dejar de rastrear",
    showOnMap: "Mostrar en el mapa",
    noPin: "No se conoce una ubicación en el mapa para esta misión.",
  },
  bags: {
    searchPlaceholder: "Buscar en las bolsas",
    searchAria: "Buscar en tus bolsas",
    sort: "Ordenar",
    sortAria: "Ordenar objetos por tipo y calidad",
    noMatches: "Ningún objeto coincide con tu búsqueda.",
    ctxEquip: "Equipar",
    ctxUse: "Usar",
    ctxSellOne: "Vender",
    ctxSellStack: "Vender el montón ({count})",
    ctxSellSome: "Vender una cantidad…",
    ctxTrade: "Añadir al intercambio",
    ctxMarket: "Elegir para publicar",
    ctxDestroy: "Destruir…",
    ctxCancel: "Cancelar",
  },
  emotes: {
  ...
  talents: {
    ...
    shapeLegend: "Cuadrado = habilidad activa · Círculo = pasivo · Octágono = elección",
    legendActive: "Habilidad activa",
    legendPassive: "Pasivo",
    legendChoice: "Nodo de elección",
    controlsTitle: "Controles",
    apply: "Aplicar cambios",
    clear: "Reiniciar puntos",
    reset: "Reiniciar",
    chooseSpec: "Elige una especialización",
    specTree: "Árbol de especialización",
    ...
    hideBuilds: "Ocultar configuraciones",
    ...
    charPoints: "{available} de {total} puntos de talento disponibles ({spent} gastados)",
    investedHeading: "Talentos invertidos",
    noTalentsInvested: "Aún no has invertido talentos",
    investedRank: "{name} — Rango {rank}/{max}",
    copy: "Copiar",
    close: "Cerrar",
    cancel: "Cancelar",
  ...
  loot: {
    lootMoneyAria: "Recoger {money}",
    lootItemAria: "Recoger {item}",
    rollAria: "Tirada de botín de grupo por {item}",
    need: "Necesidad",
    greed: "Codicia",
    pass: "Pasar",
    needAria: "Tirar Necesidad por {item}",
    greedAria: "Tirar Codicia por {item}",
    passAria: "Pasar de {item}",
  },
  vendor: {
    shiftBuyHint: "Mayús + clic para comprar una cantidad",
    sellJunk: "Vender chatarra ({money})",
    sellJunkAria: "Vender todos los objetos de calidad pobre por {money}",
    buyQtyTitle: "¿Cuántos {item} quieres comprar?",
    buyQtyInput: "Cantidad a comprar",
    buyQtyConfirm: "Comprar",
    buyQtyCancel: "Cancelar",
  },
  market: {
    searchPlaceholder: "Buscar anuncios",
    searchAria: "Buscar anuncios del mercado",
    sortAria: "Ordenar anuncios",
    filterAria: "Filtrar anuncios por categoría",
    ...
    sortUnit: "Precio por unidad",
    noMatches: "Ningún anuncio coincide con tu búsqueda.",
  },
  spellbook: {
    searchPlaceholder: "Buscar hechizos",
    searchAria: "Buscar en tu libro de hechizos",
    noMatches: "Ningún hechizo coincide con tu búsqueda.",
    nextRank: "Siguiente rango al nivel {level}",
  },
  social: {
    whoTab: "Quién",
    whoLoading: "Consultando quién está en línea…",
    whoEmpty: "No hay nadie más en línea ahora mismo.",
    whoCount: "{count} jugadores en línea",
    whoMore: "…y {count} más.",
    whoRefresh: "Actualizar",
    motdLabel: "MDD",
    motdEmpty: "No hay mensaje del día establecido.",
    motdEditAria: "Editar el mensaje del día de la hermandad",
    motdPromptTitle: "Establece el mensaje del día de la hermandad (déjalo vacío para borrarlo):",
    motdPlaceholder: "Mensaje del día",
    motdSave: "Guardar",
  },
};
...
export const en = {
  ...
  footer: {
    copyright: "2026 Wardenfall",
    githubLink: "https://github.com/chriseg0996-star/world-of-warden-",
  ...
  wiki: {
    ...
    gs1: "Choose Play Online for the persistent shared realm, or Play Offline for an instant single-player world in your browser.",
    gs2: "Pick one of nine classes. Tanks (Warrior, Paladin, Druid) hold enemy attention, healers (Priest, Shaman, Druid) keep the party alive, and damage dealers finish the fight.",
    gs3: "Follow the quest chain in Eastbrook Vale (levels 1 to 7), then move on to Mirefen Marsh and Thornpeak Heights as you approach the level 20 cap.",
    gs4: "At level 5 you earn your first talent point. Press N to open the Talents panel, pick a specialization, and spend points as you level.",
    gs5: "Group up for the dungeons: the Forgotten Crypt solo, then the Sunken Bastion, Gravewyrm Sanctum, and the Drowned Temple with a party of five.",
  },
  news: {
    title: "News & Updates",
    desc: "Read the latest patch notes, events, and community updates.",
    n1Title: "Talents & Specializations for all nine classes",
    n1Tag: "v0.7.0",
    n1Body: "Every class now has a full talent system: a shared class tree plus two specializations with masteries and signature abilities. Earn your first point at level 5, save multiple builds, and share them as build strings. Press N in game to open the panel.",
    n2Title: "The Drowned Temple opens its gates",
    n2Tag: "Dungeon",
    n2Body: "A fourth dungeon awaits parties of five in the Glimmermere reaches: fight through the flooded halls of the Drowned Temple and face Ysolei at its heart. New quests, mobs, and loot accompany the instance.",
    n3Title: "Post-cap progression: prestige and the Ashen Coliseum",
    n3Tag: "Endgame",
    n3Body: "Hitting level 20 is only the beginning. Lifetime XP now feeds virtual levels and prestige ranks with milestone cosmetics, and the 1v1 Ashen Coliseum arena tracks your rating on a realm leaderboard.",
  },
  download: {
    title: "Download Desktop Launcher",
    desc: "Get the standalone launcher for optimized performance and full-screen play.",
    stepsTitle: "Build from source",
    requirements: "Requires Node.js 20+, Rust (rustup), and Microsoft Edge WebView2 on Windows.",
    stepInstall: "npm install",
    stepDev: "npm run desktop:dev — full-screen window with hot reload",
    stepBuild: "npm run desktop:build — installer under src-tauri/target/release/bundle/",
    onlineNote: "Offline play works immediately. For online realms, also run npm run server on port 8787.",
  },
  comingSoon: {
...
export const es: typeof en = {
  ...
  wiki: {
    ...
    gs1: "Elige Jugar en Línea para el reino compartido persistente, o Jugar sin Conexión para un mundo instantáneo de un jugador en tu navegador.",
    gs2: "Elige una de las nueve clases. Los tanques (Guerrero, Paladín, Druida) retienen la atención del enemigo, los sanadores (Sacerdote, Chamán, Druida) mantienen viva a la banda, y los que infligen daño terminan el combate.",
    gs3: "Sigue la cadena de misiones en Valle de Eastbrook (niveles 1 a 7), y luego avanza a la Marisma de Mirefen y las Cumbres de Thornpeak mientras te acercas al nivel máximo 20.",
    gs4: "Al nivel 5 obtienes tu primer punto de talento. Pulsa N para abrir el panel de Talentos, elige una especialización y gasta puntos mientras subes de nivel.",
    gs5: "Agrúpate para las mazmorras: la Cripta Olvidada en solitario, y luego el Bastión Hundido, el Sagrario del Vermis Sepulcral y el Templo Hundido con un grupo de cinco.",
  },
  news: {
    title: "Noticias y Actualizaciones",
    desc: "Lee las últimas notas del parche, eventos y noticias de la comunidad.",
    n1Title: "Talentos y Especializaciones para las nueve clases",
    n1Tag: "v0.7.0",
    n1Body: "Cada clase tiene ahora un sistema completo de talentos: un árbol de clase compartido más dos especializaciones con maestrías y habilidades distintivas. Consigue tu primer punto al nivel 5, guarda varias configuraciones y compártelas como cadenas de configuración. Pulsa N en el juego para abrir el panel.",
    n2Title: "El Templo Hundido abre sus puertas",
    n2Tag: "Mazmorra",
    n2Body: "Una cuarta mazmorra espera a grupos de cinco en los alrededores de Glimmermere: ábrete paso por las salas inundadas del Templo Hundido y enfréntate a Ysolei en su corazón. Nuevas misiones, criaturas y botín acompañan a la instancia.",
    n3Title: "Progresión tras el nivel máximo: prestigio y el Coliseo Cinéreo",
    n3Tag: "Fin del juego",
    n3Body: "Alcanzar el nivel 20 es solo el principio. La experiencia acumulada alimenta ahora niveles virtuales y rangos de prestigio con cosméticos por hitos, y la arena 1c1 del Coliseo Cinéreo registra tu puntuación en una clasificación del reino.",
  },
  download: {
    ...
    stepsTitle: "Compilar desde el código",
    requirements: "Requiere Node.js 20+, Rust (rustup) y Microsoft Edge WebView2 en Windows.",
    stepInstall: "npm install",
    stepDev: "npm run desktop:dev — ventana a pantalla completa con recarga en caliente",
    stepBuild: "npm run desktop:build — instalador en src-tauri/target/release/bundle/",
    onlineNote: "El juego offline funciona de inmediato. Para reinos en línea, ejecuta también npm run server en el puerto 8787.",
  },
  comingSoon: {
