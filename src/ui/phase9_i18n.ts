...
const NPC_IDS = [
  ...
  'innkeeper_eliza', 'hunter_rowan', 'guard_ashford', 'guard_merrick',
  'wounded_scout',
...
const esData: LocaleData = {
  ...
  npcRows: [
    ...
    ['Guardia Ashford', 'Guardia de la ciudad', 'Sigue tu camino, ciudadano. La plaza permanece segura bajo mi vigilancia.'],
